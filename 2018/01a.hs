-- --- Day 1: Chronal Calibration --- "We've detected some temporal anomalies," one
-- --of Santa's Elves at the Temporal Anomaly Research and Detection Instrument
-- --Station tells you. She sounded pretty worried when she called you down here.
-- --"At 500-year intervals into the past, someone has been changing Santa's
-- --history!"
--
...
main = do
  s <- readFile("./01a.txt")
  print (sum (map signedInt (lines s)))
